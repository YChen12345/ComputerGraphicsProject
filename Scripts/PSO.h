...
public:
    ...
    void createPSO(Core* core, std::string name, ID3DBlob* vs, ID3DBlob* ps, D3D12_INPUT_LAYOUT_DESC layout, bool enableDepth = true, bool alpha = true)
    {
